 ...
 */
public class CountrySelectionControllerOLD {
    ...
    public void initialise() throws FileNotFoundException {
        try {
            resourcesPath = String.valueOf(new File(CountrySelectionControllerOLD.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()));
    ...
    private void setupDetails() {
        ...
        countryDesc.setAlignment(Pos.TOP_LEFT);
    ...
    private void setupContinentBox() {
        ...
        NodePlacer.placeControlRelativeToScreen(view, dropDownBox, 0.05, 0.025 + 0.1, 0, 0, 35, 175);
    ...
    private void setupScreenTitle() {
        ...
        NodePlacer.placeLabelRelativeToScreen(view, screenTitle, 0.05, 0.025, 0.33, 0.15, 66, 200);
    }
        ...
        for (Map.Entry<Node, String> flagEntry : flags.entrySet()) {
            ...
            flag.setOnMouseClicked(event -> {
                if (isEnlarged && !selectedFlagName.equals(flagEntry.getValue())) {
                    ...
                    //flags.keySet().forEach(flagToMove -> flagToMove.setLayoutY(flagToMove.getLayoutY()-100));
